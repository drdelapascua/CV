...
Gremer, J.R., Chiono, A., **Suglia, E.**, Bontrager, M., Okafor, L. and J. Schmitt. *In press.* Variation in the seasonal germination niche across an elevational gradient: The role of germination cueing in current and future climates. *American Journal of Botany*.
...
**Peer Mentor**, Population Biology Graduate Group, UC Davis \hfill 2019-present
...
\begin{tabbing}
\textit{Programming:} \= R, Unix, JAGS, Stan, MySQL  \\ [1.5ex]
\textit{Software:} \> JMP, ImageJ, G*Power, SAS, Estimate S, Microsoft Office, Adobe Illustrator, Procreate \\ [1.5ex]
\end{tabbing}
